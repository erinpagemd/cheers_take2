...
EOS
  ...
  def test_one_valid_argument_date
    output = `./cheers 08/25`
    expected = <<EOS
Awesome!  Your birthday is in 45 days!
Happy Birthday in advance!
EOS
    assert_equal expected, output
  end

  def test_one_invalid_argument_date_month_last
    output = `./cheers 25/08`
    expected = <<EOS
I'd cheer for you, if only I knew who you were :(
Try again with ./cheers.rb [Name] [MM/DD Birthday]
EOS
  ...
  def test_one_invalid_argument_date_with_year
    output = `./cheers 08/25/15`
    expected = <<EOS
I'd cheer for you, if only I knew who you were :(
Try again with ./cheers.rb [Name] [MM/DD Birthday]
EOS
...
Awesome! Your birthday is in 339 days! Happy Birthday in advance!
EOS
    assert_equal expected, output
  end
...
EOS
  ...
  def test_two_arguments_one_valid_name
...
EOS
  ...
  def test_two_arguments_one_valid_date
    output = `./cheers`
    expected = <<EOS
I'd cheer for you, if only I knew who you were :(
Try again with ./cheers.rb [Name] [MM/DD Birthday]
